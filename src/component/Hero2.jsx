          ...
          <div className="d-flex flex-column gap-5">
            ...
            <div className="d-flex flex-column gap-3">
              <div className="d-flex flex-column gap-2">
                <h1 className="mb-0 display-4 fw-bolder">Your Personalized Secret Santa Wishlist Starts Here</h1>
                <p className="mb-0">Add your wishes, gift ideas, and surprises so your Secret Santa knows exactly what will make your holidays magical.</p>
              </div>
              <ul className="list-unstyled mb-0 d-flex flex-column gap-2">
                <li className="d-flex flex-row gap-2">
                  ...
                  <span>Easy & fun wishlist builder</span>
                </li>
                <li className="d-flex flex-row gap-2">
                  <span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-check-circle-fill text-success" viewBox="0 0 16 16">
                  ...
                  <span>Add links, descriptions & budget</span>
                </li>
                <li className="d-flex flex-row gap-2">
                  <span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-check-circle-fill text-success" viewBox="0 0 16 16">
                  ...
                  <span>Share with your Secret Santa securely</span>
                </li>
              </ul>
            </div>
            <div className="d-grid d-md-flex flex-row gap-2">
              <Link to="/wishlist" className="btn btn-primary btn-lg">Create Your Wishlist</Link>
              <Link to="/scratch2" className="btn btn-outline-secondary btn-lg">View My Giftee</Link>
            </div>
          </div>
        </div>
        <div className="col-xxl-6 offset-xxl-1 col-lg-7 col-12">
          <div className="row gx-0 gy-4 gy-lg-0">
              ...
              <div className="position-relative me-n7">
                <div className="position-absolute bottom-25 start-0 ms-n8 end-0 d-flex flex-column align-items-start">
                  ...
                  <div className="bg-white rounded-pill py-2 px-3 shadow mb-2 d-inline-block">
                    ...
                    <span className="text-dark fw-semibold">Wisheslists</span>
                  </div>
            ...
            <div className="col-md-6 mt-8 mt-md-0">
              <div className="bg-warning d-flex justify-content-center rounded-4 position-relative" style={{ paddingBottom: "150px", paddingTop: "100px" }}
>
                <img src="https://blogger.googleusercontent.com/img/a/AVvXsEi7buYHEZ3sw5oQ6OJ4T_G6Cm0GKqbMghyWvb5KLBzlsdwF_AgwZRcSSByRuTNiIb8u_vC35GXB4dugkXCSYcq_Jf-4NKxUEUrVk3gP9f3SKsjRmxhbbu6Mn3JhaTK2wNFypmr4r8XhdyGmRkpApzxB2EvpThHNKsH_SiMWWtFvEn2trndlapP9aJQyTkU" alt="" className="position-absolute rounded-4" style={{width: "500px", bottom: "-190px", left: "-155px", zIndex: "500"}} />
              </div>
            </div>
            <div className="col-md-6 flex-column justify-content-end d-none d-md-flex">
              <div className="bg-primary d-flex justify-content-center rounded-4 position-relative mx-5" style={{ paddingBottom: "150px", paddingTop: "100px" }}
>
                ...
                <div className="bg-white rounded-4 p-3 position-absolute bottom-10 start-10 mb-3 shadow">
                  <div className="avatar-group mb-2">
                    <span className="avatar avatar-md">
                      ...
                      <img alt="avatar" src="https://geeksui.codescandy.com/geeks/assets/images/avatar/avatar-1.jpg" className="rounded-circle" style={{width: "30px"}} />
                    </span>
                    
                    <span className="avatar avatar-md">
                      <img alt="avatar" src="https://geeksui.codescandy.com/geeks/assets/images/avatar/avatar-2.jpg" className="rounded-circle" style={{width: "30px"}}/>
                    </span>
                    
                    <span className="avatar avatar-md">
                      <img alt="avatar" src="https://geeksui.codescandy.com/geeks/assets/images/avatar/avatar-3.jpg" className="rounded-circle" style={{width: "30px"}}/>
                    </span>
                    
                    <span className="avatar avatar-md">
                      <img alt="avatar" src="https://geeksui.codescandy.com/geeks/assets/images/avatar/avatar-4.jpg" className="rounded-circle" style={{width: "30px"}}/>
                    </span>
                  </div>
                  <div className="text-dark fw-bold fs-4">1000+</div>
                  <div className="text-gray-500">Sharing their Secret Santa wishes 🎅✨</div>
                </div>
              </div>
            </div>
          </div>
